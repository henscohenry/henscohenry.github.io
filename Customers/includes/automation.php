...
class Automate {
	...
	public $randomChar="A",$randomTicketChar="P",$randomNumber,$timestamp,$random_user_id,$random_admin_code,$photo_id,$ticket_id,$pay_id,$bk_id;
	...
	public function generate_bookar_id()
	{
		$this->bk_id = $this->generate_random_number().$this->generate_random_char();
	}
